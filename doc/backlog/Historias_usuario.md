...
- Dado que ingreso un correo/nombre usuario o contraseña incorrectos  
...
## HU03 – Publicar productos o servicios
**Funcionalidad:** Crear publicaciones  

**Escenario: Publicación exitosa de producto o servicio**  
- Dado que soy emprendedor y estoy en la sección de publicaciones  
- Cuando completo título, descripción, precio y agrego una foto (y promoción opcional)  
...
## HU04 – Editar o eliminar publicaciones
...
## HU05 – Ver catálogo de productos
...
## HU06 – Ver detalle de producto y contactar vía WhatsApp
