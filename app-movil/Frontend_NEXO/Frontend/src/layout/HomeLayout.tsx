...
interface HomeLayoutProps {
  ...
  titleAfter?: string;
  headerAction?: ReactNode;   // botón u otra acción (derecha)
  headerTitle?: ReactNode;    // 🔹 NUEVO: texto/título (izquierda)
}
      ...
      <div className="home-shell">
        <div className="home-card">
          ...
          <div className="home-hero">
            <div
              className="home-heroLayer is-active"
            ...
            <div
              className={`home-heroLayer ${fade ? "fade-in" : ""}`}
          ...
          {/* 🔹 BARRA ENTRE HERO Y TÍTULO: TÍTULO IZQ + BOTÓN DER */}
          {(headerTitle || headerAction) && (
            <div className="home-actionBar">
              {headerTitle && (
                <div className="home-actionTitle">{headerTitle}</div>
              )}

              {headerAction && (
                <div className="home-actionSlot">{headerAction}</div>
              )}
            </div>
          )}
